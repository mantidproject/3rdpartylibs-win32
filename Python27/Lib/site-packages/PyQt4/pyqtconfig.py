...
_pkg_config = {
    'pyqt_bin_dir':      _python27_dir,
    'pyqt_config_args':  '--no-qsci-api',
    'pyqt_mod_dir':      os.path.join(_python27_dir,'Lib\\site-packages\\PyQt4'),
    ...
    'pyqt_sip_dir':      os.path.join(_python27_dir,'sip\\PyQt4'),
    ...
    'qt_data_dir':       _qtlib_dir,
    'qt_dir':            _qtlib_dir,
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        _qtinc_dir,
    'qt_lib_dir':        _qtlib_dir,
    'qt_threaded':       1,
    'qt_version':        0x040804,
    'qt_winconfig':      'shared'
}
