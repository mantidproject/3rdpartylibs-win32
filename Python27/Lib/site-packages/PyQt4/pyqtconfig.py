...
_pkg_config = {
    'pyqt_bin_dir':      'C:\\Users\\dmn58364\\Code\\mantid\\Code\\Third_Party\\lib\\win32\\Python27',
    'pyqt_config_args':  '--no-qsci-api',
    'pyqt_mod_dir':      'C:\\Users\\dmn58364\\Code\\mantid\\Code\\Third_Party\\lib\\win32\\Python27\\Lib\\site-packages\\PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtDeclarative QtOpenGL QtScript QtScriptTools QtSql QtSvg QtTest QtXml QtXmlPatterns phonon QtDesigner QAxContainer',
    'pyqt_sip_dir':      'C:\\Users\\dmn58364\\Code\\mantid\\Code\\Third_Party\\lib\\win32\\Python27\\sip\\PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_7_1 -x Py_v3 -g',
    'pyqt_version':      0x040803,
    'pyqt_version_str':  '4.8.3',
    'qt_data_dir':       'C:\\Builds\\qt-everywhere-opensource-src-4.8.4',
    'qt_dir':            'C:\\Builds\\qt-everywhere-opensource-src-4.8.4',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'C:\\Builds\\qt-everywhere-opensource-src-4.8.4\\include',
    'qt_lib_dir':        'C:\\Builds\\qt-everywhere-opensource-src-4.8.4\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040804,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '',
    'INCDIR_QT':                'C:\\Builds\\qt-everywhere-opensource-src-4.8.4\\include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                'C:\\Builds\\qt-everywhere-opensource-src-4.8.4\\lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    ...
    'MKDIR':                    'mkdir',
    'MOC':                      'C:\\Builds\\qt-everywhere-opensource-src-4.8.4\\bin\\\\moc.exe',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    ''
}
