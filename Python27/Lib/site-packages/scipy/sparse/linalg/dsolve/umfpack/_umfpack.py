...
def umfpack_dl_solve(*args):
  """
    umfpack_dl_solve(UF_long sys, UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, double [] X, 
        double const [] B, void * Numeric, double const [20] Control, double [90] Info) -> UF_long
    """
...
def umfpack_zl_solve(*args):
  """
    umfpack_zl_solve(UF_long sys, UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, double const [] Az, 
        double [] Xx, double [] Xz, double const [] Bx, double const [] Bz, 
        void * Numeric, double const [20] Control, double [90] Info) -> UF_long
    """
...
def umfpack_dl_triplet_to_col(*args):
  """
    umfpack_dl_triplet_to_col(UF_long n_row, UF_long n_col, UF_long nz, UF_long const [] Ti, UF_long const [] Tj, 
        double const [] Tx, UF_long [] Ap, UF_long [] Ai, double [] Ax, UF_long [] Map) -> UF_long
    """
...
def umfpack_zl_triplet_to_col(*args):
  """
    umfpack_zl_triplet_to_col(UF_long n_row, UF_long n_col, UF_long nz, UF_long const [] Ti, UF_long const [] Tj, 
        double const [] Tx, double const [] Tz, UF_long [] Ap, UF_long [] Ai, double [] Ax, 
        double [] Az, UF_long [] Map) -> UF_long
    """
...
def umfpack_dl_transpose(*args):
  """
    umfpack_dl_transpose(UF_long n_row, UF_long n_col, UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, 
        UF_long const [] P, UF_long const [] Q, UF_long [] Rp, UF_long [] Ri, 
        double [] Rx) -> UF_long
    """
...
def umfpack_zl_transpose(*args):
  """
    umfpack_zl_transpose(UF_long n_row, UF_long n_col, UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, 
        double const [] Az, UF_long const [] P, UF_long const [] Q, UF_long [] Rp, 
        UF_long [] Ri, double [] Rx, double [] Rz, UF_long do_conjugate) -> UF_long
    """
...
def umfpack_dl_symbolic(*args):
  """
    umfpack_dl_symbolic(UF_long n_row, UF_long n_col, UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, 
        double const [20] Control, double [90] Info) -> UF_long
    """
...
def umfpack_zl_symbolic(*args):
  """
    umfpack_zl_symbolic(UF_long n_row, UF_long n_col, UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, 
        double const [] Az, double const [20] Control, double [90] Info) -> UF_long
    """
...
def umfpack_dl_numeric(*args):
  """
    umfpack_dl_numeric(UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, void * Symbolic, double const [20] Control, 
        double [90] Info) -> UF_long
    """
...
def umfpack_zl_numeric(*args):
  """
    umfpack_zl_numeric(UF_long const [] Ap, UF_long const [] Ai, double const [] Ax, double const [] Az, 
        void * Symbolic, double const [20] Control, double [90] Info) -> UF_long
    """
...
def umfpack_dl_get_lunz(*args):
  """
    umfpack_dl_get_lunz(UF_long * lnz, UF_long * unz, UF_long * n_row, UF_long * n_col, UF_long * nz_udiag, 
        void * Numeric) -> UF_long
    """
...
def umfpack_zl_get_lunz(*args):
  """
    umfpack_zl_get_lunz(UF_long * lnz, UF_long * unz, UF_long * n_row, UF_long * n_col, UF_long * nz_udiag, 
        void * Numeric) -> UF_long
    """
...
def umfpack_dl_get_numeric(*args):
  """
    umfpack_dl_get_numeric(UF_long [] Lp, UF_long [] Lj, double [] Lx, UF_long [] Up, UF_long [] Ui, double [] Ux, 
        UF_long [] P, UF_long [] Q, double [] Dx, UF_long * do_recip, double [] Rs, 
        void * Numeric) -> UF_long
    """
...
def umfpack_zl_get_numeric(*args):
  """
    umfpack_zl_get_numeric(UF_long [] Lp, UF_long [] Lj, double [] Lx, double [] Lz, UF_long [] Up, UF_long [] Ui, 
        double [] Ux, double [] Uz, UF_long [] P, UF_long [] Q, double [] Dx, 
        double [] Dz, UF_long * do_recip, double [] Rs, void * Numeric) -> UF_long
    """
