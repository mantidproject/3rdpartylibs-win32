...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    _python27_dir,
    'default_mod_dir':    os.path.join(_python27_dir, 'Lib\\site-packages'),
    'default_sip_dir':    os.path.join(_python27_dir, 'sip'),
    'deployment_target':  '',
    'platform':           'win32-msvc2012',
    'py_conf_inc_dir':    os.path.join(_python27_dir,'Include'),
    'py_inc_dir':         os.path.join(_python27_dir,'Include'),
    'py_lib_dir':         os.path.join(_python27_dir,'libs'),
    'py_version':         0x020703,
    'sip_bin':            os.path.join(_python27_dir,'sip'),
    'sip_config_args':    '--platform win32-msvc2012',
    'sip_inc_dir':        os.path.join(_python27_dir,'Include'),
    'sip_mod_dir':        os.path.join(_python27_dir, 'Lib\\site-packages'),
